	...
	factory: (require) => {
		...
		*/
		function HostField(props) {
			...
			const options = props.suggestions.filter((host) => !present.has(host) && (tail === "" || host.toLowerCase().includes(tail.toLowerCase())));
			const add = (host) => {
				if (props.disabled) return;
				const parts = props.value.trim() === "" ? [] : props.value.trim().split(/[,\s]+/).filter(Boolean);
				const last = parts[parts.length - 1];
				const committed = /* @__PURE__ */ new Set([...props.suggestions, ...parts.slice(0, -1)]);
				const base = last !== void 0 && !committed.has(last) ? parts.slice(0, -1) : parts;
				if (!base.includes(host)) props.onEdit(base.length === 0 ? host : `${base.join(", ")}, ${host}`);
			};
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: card_module_css_default.field,
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							open ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("ul", {
								...
								id: `${props.id}-list`,
								role: "listbox",
								children: options.length > 0 ? options.map((host) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("li", {
									role: "option",
									"aria-selected": false,
